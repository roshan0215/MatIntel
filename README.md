...
**End-to-end computational materials screening and discovery platform** for identifying high-potential materials across 71 application categories. Combines domain-specific scoring with real-world viability assessment and AI-driven synthesizability predictions via CLscore.
...
4. [The 71 Scoring Categories](#the-71-scoring-categories)
   ...
   - [Domain 9: Nuclear & Extreme Environment](#domain-9-nuclear--extreme-environment)
   - [Domain 10: Energy Storage Additions](#domain-10-energy-storage-additions)
   - [Domain 11: Solar & Optical Additions](#domain-11-solar--optical-additions)
   - [Domain 12: Catalysis Additions](#domain-12-catalysis-additions)
   - [Domain 13: Electronics Additions](#domain-13-electronics-additions)
   - [Domain 14: Structural & Mechanical](#domain-14-structural--mechanical)
   - [Domain 15: Environmental Additions](#domain-15-environmental-additions)
...
12. [Top-10 Snapshot (Current Data)](#top-10-snapshot-current-data)
...
- **71 application-specific scorers** driven by rigorous materials science principles (band gap windows, crystal symmetry requirements, element chemistry, formation energy thresholds)
...
Featured Dataset (element properties, structure metrics via matminer)
  ↓
Scored Dataset (71-category scores + viability + CLscore)
  ↓
...
### 16. CO2 Reduction Catalyst (CO2RR)
...
### 70. Photocatalytic CO2 Reduction
